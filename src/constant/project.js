        ...
        list: [
          {
            ...
            content: [
              {
                text: "피그마 프로그램 사용과 DoTween, Text Mesh Pro, 배경 블러 기능 추가 등의 UI 관련 연구개발을 주도적으로 진행했습니다.<br/><br/>R&D를 진행하면서 특히 클라이언트 개발자 분들과 커뮤니케이션하는 일이 많았고, 그렇게 협업을 진행하다 보니 기술 관련 커뮤케이션 능력이 많이 향상되었습니다. R&D를 진행한 부분들로 인해 여러가지 면에서 프로젝트의 퀄리티도 상승한 것 같습니다.",
                type: "text",
              },
            ],
          },
        ...
        list: [
          {
            ...
            content: [
              {
                text: "UX부터 UI까지 산정된 작업 기간이 2달 내였는데, 퇴근 후에 진행하는 사이드프로젝트였기 때문에 실제 작업 시간은 더 빠듯했습니다.<br/><br/>따라서 레이아웃은 수정사항이 발생하더라도 쉽게 대응할 수 있는 무난한 방향으로 설정하고, GUI는 패턴과 물결 모양을 여러 화면에서 반복해 사용하는 최대한 단순한 구성으로 작업했습니다. 그렇게 작업하면서 최대한 '빠르게' '가볍게' 작업하는 방법론을 체화할 수 있었던 것 같습니다.",
                type: "text",
              },
            ],
          },
          {
            ...
            content: [
              {
                text: `유령다운 알파 그라데이션과 캐릭터 바리에이션을 위해 유령 캐릭터의 셰이더를 작업하며 버텍스 셰이더에 입문했습니다.<br/><br/>모델의 버텍스 포지션 값을 사용해서 그라데이션의 범위를 자유롭게 조정 가능하도록 작성했습니다. 서페이스 셰이더에서 버텍스 셰이더를 어떻게 사용해야 하는지와 구조체를 어떻게 수정해야 하는지 배울 수 있었습니다.<br/><br/><a href="https://do-workspace.tistory.com/36" target="_blank">관련 블로그 포스팅</a>`,
                type: "text",
              },
              // {
